import { g as getModularInstance, a as getApp, _ as _getProvider, e as _registerComponent, r as registerVersion, L as LogLevel, F as FirebaseError, S as SDK_VERSION, C as Component, p as Logger, b as isMobileCordova, c as isReactNative, s as isElectron, n as isIE, t as isUWP, f as isBrowserExtension } from '../common/index.esm2017-2035f3e4.js';
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Gc$1({
            next: r => {
                ...
                i.reject(new Q$1(G.UNAVAILABLE, "Failed to get document because the client is offline.")) : u && r.fromCache && s && "server" === s.source ? i.reject(new Q$1(G.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(r);
            },
            error: t => i.reject(t)
...
function ll(t) {
    t = Ia$1(t, ba$1);
    const e = Ia$1(t.firestore, Fa$1);
    return ua$1(La$1(e), t._key).then((n => bl(e, t, n)));
}
 ...
 */ !function(t, e = !0) {
    ...
    }), "PUBLIC")), registerVersion(D$1, "3.4.11", t), 
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    registerVersion(D$1, "3.4.11", "esm2017");
}();

export { Da as doc, ll as getDoc, Ba as getFirestore, yl as setDoc };
